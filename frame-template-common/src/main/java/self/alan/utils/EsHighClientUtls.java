...
public class EsHighClientUtls {
     ...
     * @throws IOException
     */
    public void createIndex(String index, String type,String id,String jsonStr) throws IOException {
        ...
        IndexRequest source = request.source(jsonStr, XContentType.JSON);
        //同步执行
...
//     */
    public boolean checkIndexExists(String indexName) {
        GetIndexRequest request = new GetIndexRequest().indices(indexName).humanReadable(true).local(false).includeDefaults(false);
...
//        }
    ...
    public void addDocByJson(String indexName, String typeName, String id, String jsonString) throws IOException{
        ...
        if (!checkIndexExists(indexName)) {
            createIndex(indexName, typeName,id,jsonString);
        }
    ...
    public void updateDocByJson(String index, String type, String id, String jsonString) throws IOException {
        ...
        if (!checkIndexExists(index)) {
            createIndex(index, type,id,jsonString);
        }
    ...
    public void bulkAdd(List<Map<String, String>> params) throws IOException {
        ...
        for (Map<String, String> dataMap : params) {
            ...
            if (StringUtils.isNotBlank(id) && validate(jsonString)) {
