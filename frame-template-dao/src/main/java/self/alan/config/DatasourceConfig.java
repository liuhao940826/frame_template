...
import self.alan.interceptor.PagerPluginInterceptor;
...
@MapperScan(value = "self.alan.mapper", sqlSessionFactoryRef = "sqlSessionFactoryBean")
...
//    private Class<? extends DataSource> datasourceType;
    ...
    public SqlSessionFactoryBean sqlSessionFactory(@Qualifier("dataSource") DataSource dataSource) {
        ...
        ssfb.setTypeAliasesPackage("self.alan.po");
