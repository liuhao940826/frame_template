package com.ovopark.cloud.projection.aspect;

import com.alibaba.fastjson.JSON;
import com.ovopark.cloud.projection.annotation.AutoCache;
import com.ovopark.cloud.projection.annotation.CacheType;
import com.ovopark.cloud.projection.constants.CommonConstants;
...
public class AutoCacheAspect {
	...
	@Pointcut("@annotation(com.ovopark.cloud.projection.annotation.AutoCache)")
